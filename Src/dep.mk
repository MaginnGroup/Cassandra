...
deletion.o: type_definitions.o run_variables.o random_generators.o simulation_properties.o energy_routines.o fragment_growth.o
energy_routines.o: type_definitions.o run_variables.o file_names.o pair_nrg_routines.o random_generators.o run_variables.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o run_variables.o type_definitions.o run_variables.o
file_names.o:
fragment_growth.o: run_variables.o energy_routines.o random_generators.o read_write_checkpoint.o rotation_routines.o io_utilities.o file_names.o energy_routines.o rotation_routines.o io_utilities.o file_names.o energy_routines.o run_variables.o random_generators.o run_variables.o random_generators.o io_utilities.o type_definitions.o rotation_routines.o type_definitions.o run_variables.o
...
minimum_image_separation.o: run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o run_variables.o type_definitions.o
...
precalculate.o: run_variables.o file_names.o energy_routines.o
