...
SUBROUTINE Get_Mie_Nonbond
  ...
  DO
	...
	! the specified mie_n and mie_m exponents for a given species type.
	   ...
	   WRITE(logunit,'(A17,F7.2,A7,F7.2,A6,F7.2,A7,F7.2)') 'Mie exponent for ', String_To_Int(line_array(1)), '   and ', String_To_Int(line_array(2)),  '   is ', String_To_Double(line_array(3)), '   and ', String_To_Double(line_array(4))
        END DO
