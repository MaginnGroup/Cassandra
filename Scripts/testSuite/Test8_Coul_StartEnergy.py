...
numChecks = 2
distList = [1.0,10.]
analyticList = [None] * numChecks #this list will hold the analytic answers
cassTestList = [None] * numChecks #this list will hold cassandra's answers
cassStr = "Total system energy" # this string uniquely identifies cassandra's answer in the logfile
