...
# This is Test 1 in a series of tests in order to check the functionality of Cassandra. 
...
# Finding a string - using an if statement in the function
# For the first test
...
# Next we will extract and compare the number in order to Pass Test 1 (each of the 4 subtests will be referred to as a check) 
num1 = []
