...
with open("lj_sample_config_periodic1.xyz") as f: 
	for line_nbr, line in enumerate(f):
		if (line_nbr == 0):
			...
			numbers_float = [float(x) for x in numbers_str]
			numbers_float = [num*3*sigma for num in numbers_float]
...
replace_line("nist.inp", 60, "read_config 2 nist2.xyz\n")
...
replace_line("nist.inp", 60, "read_config 2 nist3.xyz\n")
...
replace_line("nist.inp", 60, "read_config 2 nist4.xyz\n")
...
replace_line("nist.inp", 60, "read_config 2 nist1.xyz\n")
