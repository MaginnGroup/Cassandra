...
The script mcf\_gen.py is a tool that aims to ease the setup of MCF files from scratch (see section \ref{sec:MCF_File} to learn more
...
Check the file pentane.mcf for any possible errors.
