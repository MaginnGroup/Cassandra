...
All energies are output in kJ/mol and are extensive, i.e.,
if the numbers of molecules in a simulation are doubled, the magnitude of the energy will also double.
To get intensive energies of a single species simulation, divide the output energies by the number of molecules.
