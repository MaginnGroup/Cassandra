...
Note that the files \texttt{box1.readold} and \texttt{box2.readold} differ from a typical XYZ file in that the first line is the total number of molecules
of each species. For example, for a mixture of 50 methane (species 1) molecules and 30 butane (species 2) molecules, one of these files 
would look like \\
