...
This keyword should only be used if VDW\_Style is set to \texttt{LJ mie} or \texttt{LJ mie\_cut\_shift}.
...
To illustrate the use of the \texttt{custom} option, consider a mixture of methane (species 1) and butane (species 2) united atom
