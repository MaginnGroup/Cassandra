...
The options ORTHOGONAL and CELL\_MATRIX are only supported for constant volume simulations (i.e. NVT or GCMC),
...
for species 2. For box 2, the maximum rotational width will be 60\degree\ for
species 1 and 30\degree\ for species 2. Note that, since the maximum rotational
 width of species 2 is set to 0.0\degree\ in both boxes, no rotational moves will be
 attempted on species 2.
...
During the swap, the donor and receiving boxes are chosen randomly. 
